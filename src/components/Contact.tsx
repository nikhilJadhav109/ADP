...
Looking forward to your response!
  ...
  // Framer Motion variants (re-using from previous component for consistency)
  ...
  return (
    <section id="contact" className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-8">
              ...
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-teal-100 dark:bg-teal-900 rounded-xl flex items-center justify-center mr-4 flex-shrink-0 shadow-inner">
            ...
            >
              <h4 className="font-bold text-xl text-gray-900 dark:text-white mb-2">Need Immediate Assistance?</h4>
              ...
              <div className="flex flex-wrap gap-3">
                <motion.a
                  ...
                  className="bg-teal-600 hover:bg-teal-700 dark:bg-teal-500 dark:hover:bg-teal-600 text-white px-4 py-2.5 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center shadow-md hover:shadow-lg"
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center shadow-md hover:shadow-lg"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
            ...
            {!isSubmitted ? (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.div variants={formFieldVariants} transition={{ delay: 0.1 }}>
