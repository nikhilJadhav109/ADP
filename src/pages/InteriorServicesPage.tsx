...
const BuildingIcon = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
  <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-4-4h1m-1 4h1"></path></svg>
);

// Inline SVG for Wrench
const WrenchIcon = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
...
const InteriorServicesPage: React.FC = () => {
  ...
  const pageDescription = "Explore our comprehensive residential, commercial, and turnkey interior design solutions in Pune. We create inspiring spaces with premium, branded materials.";
  const pageKeywords = "interior design Pune, residential interior design Pune, commercial interior design Pune, turnkey interior solutions Pune, luxury interior design Pune, home interiors Pune, office interiors Pune, interior decorator Pune, best interior designer Pune";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image:alt" content="Interior Design Services by Agrawal Ply Decor" />
        ...
        <section className="py-16 md:py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Premium <span className="text-teal-400">Interior Design</span> Solutions
            </h1>
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              Transform your spaces into breathtaking realities with our expert residential, commercial, and turnkey interior design services.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Our <span className="text-teal-600 dark:text-teal-400">Seamless Interior Process</span>
              </h2>
