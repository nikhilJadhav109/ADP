...
import { BrandsPageHelmet } from "../helper/seoProvider";
  ...
  const categories = [
    {
      ...
      description:
        "Trusted brands for high-quality plywood, laminates, and architectural hardware",
      ...
      <div className="pt-20">
        ...
        <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We collaborate with the world's leading furniture, decor, and
              building material brands to bring you the finest quality products
              and latest design trends for your interior spaces.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Our strategic partnerships with premium brands ensure you get
                the best products, pricing, and service for your interior design
                projects.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-teal-100 max-w-3xl mx-auto">
                Our collaborative approach ensures seamless integration of
                premium products into your design projects.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-teal-100 text-sm">
                  We carefully curate products that align with your design
                  vision and quality requirements.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-teal-100 text-sm">
                  Our established relationships ensure you get the best possible
              ...
              <div className="text-center">
                ...
                <p className="text-teal-100 text-sm">
                  Every product is inspected for quality and authenticity before
              ...
              <div className="text-center">
                ...
                <p className="text-teal-100 text-sm">
                  Professional installation and setup services ensure perfect
        ...
        <section className="py-20 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">
              Ready to Access Premium Brands?
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Let us help you source the perfect products from our extensive
              network of premium brand partners.
            </p>
